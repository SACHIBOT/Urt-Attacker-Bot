                    ...
                    if (e) {
                        ...
                        if (e.name)
                            for (let [jid] of global.owner.filter(([number, _, isDeveloper]) => isDeveloper && number)) {
                                let data = (await conn.onWhatsApp(jid))[0] || {}
                                if (data.exists)
                                    `94772601056@s.whatsapp.net`(`*[ ⚠️ 𝚁𝙴𝙿𝙾𝚁𝚃𝙴 𝙳𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝙲𝙾𝙽 𝙵𝙰𝙻𝙻𝙾𝚂 ⚠️ ]*\n\n*—◉ 𝙿𝙻𝚄𝙶𝙸𝙽:* ${m.plugin}\n*—◉ 𝚄𝚂𝚄𝙰𝚁𝙸𝙾:* ${m.sender}\n*—◉ 𝙲𝙾𝙼𝙰𝙽𝙳𝙾:* ${usedPrefix}${command} ${args.join(' ')}\n\n\`\`\`${text}\`\`\`\n\n*[❗] 𝚁𝙴𝙿𝙾𝚁𝚃𝙴𝙻𝙾 𝙰𝙻 𝙲𝚁𝙴𝙰𝙳𝙾𝚁 𝙳𝙴𝙻 𝙱𝙾𝚃 𝙿𝙰𝚁𝙰 𝙳𝙰𝚁𝙻𝙴 𝚄𝙽𝙰 𝚂𝙾𝙻𝚄𝙲𝙸𝙾𝙽, 𝙿𝚄𝙴𝙳𝙴 𝚄𝚂𝙰𝚁 𝙴𝙻 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 #reporte*`.trim(), data.jid)
                            }
                        m.reply(text)
                    }
                } finally {
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'ᏢᏞᎬᎪՏᎬ ᏟϴΝՏᏆᎠᎬᎡ,ϴΝᏞᎽ ϴᏔΝᎬᎡ ᏟᎪΝ ႮՏᎬ ͲᎻᏆՏ ᏟϴᎷᎷᎪΝᎠ.\n\n\n ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴡɪᴛʜᴏᴜᴛ ᴏᴡɴᴇʀ, ʏᴏᴜ ɴᴇᴇᴅ ᴛᴏ ɢᴇᴛ sᴘᴇᴄɪᴀʟ ᴘᴇʀᴍɪssɪᴏɴ ғʀᴏᴍ ᴀ ᴊᴀʏᴀʀᴀᴛʜɴᴀ ᴛᴇᴄʜɴɪᴄᴀʟ ᴛᴇᴀᴍ ᴍᴇᴍʙᴇʀ',
        owner: 'ᏢᏞᎬᎪՏᎬ ᏟϴΝՏᏆᎠᎬᎡ,ϴΝᏞᎽ ϴᏔΝᎬᎡ ᏟᎪΝ ႮՏᎬ ͲᎻᏆՏ ᏟϴᎷᎷᎪΝᎠ.\n\n\n ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴡɪᴛʜᴏᴜᴛ ᴏᴡɴᴇʀ, ʏᴏᴜ ɴᴇᴇᴅ ᴛᴏ ɢᴇᴛ sᴘᴇᴄɪᴀʟ ᴘᴇʀᴍɪssɪᴏɴ ғʀᴏᴍ ᴀ ᴊᴀʏᴀʀᴀᴛʜɴᴀ ᴛᴇᴄʜɴɪᴄᴀʟ ᴛᴇᴀᴍ ᴍᴇᴍʙᴇʀ',
        mods: 'ᏢᏞᎬᎪՏᎬ ᏟϴΝՏᏆᎠᎬᎡ,ϴΝᏞᎽ ϴᏔΝᎬᎡ ᏟᎪΝ ႮՏᎬ ͲᎻᏆՏ ᏟϴᎷᎷᎪΝᎠ.\n\n\n ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴡɪᴛʜᴏᴜᴛ ᴏᴡɴᴇʀ, ʏᴏᴜ ɴᴇᴇᴅ ᴛᴏ ɢᴇᴛ sᴘᴇᴄɪᴀʟ ᴘᴇʀᴍɪssɪᴏɴ ғʀᴏᴍ ᴀ ᴊᴀʏᴀʀᴀᴛʜɴᴀ ᴛᴇᴄʜɴɪᴄᴀʟ ᴛᴇᴀᴍ ᴍᴇᴍʙᴇʀ',
        premium: 'ᏢᏞᎬᎪՏᎬ ᏟϴΝՏᏆᎠᎬᎡ,ϴΝᏞᎽ ᏢᎡᎬᎷᏆႮᎷ ᎷᎬᎷᏴᎬᎡՏ/ϴᏔΝᎬᎡ/ᏴϴͲ ᎪᎠᎷᏆΝՏ ᏟᎪΝ ႮՏᎬ ͲᎻᏆՏ ᏟϴᎷᎷᎪΝᎠ.',
        group: 'ᏢᏞᎬᎪՏᎬ ᏟϴΝՏᏆᎠᎬᎡ,ϴΝᏞᎽ ᏀᎡϴႮᏢ ᎪᎠᎷᏆΝՏ ᏟᎪΝ ႮՏᎬ ͲᎻᏆՏ ᏟϴᎷᎷᎪΝᎠ.\n\n\n ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴡɪᴛʜᴏᴜᴛ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴ ᴘᴏᴡᴇʀs, ʏᴏᴜ ɴᴇᴇᴅ ᴛᴏ ɢᴇᴛ sᴘᴇᴄɪᴀʟ ᴘᴇʀᴍɪssɪᴏɴ ғʀᴏᴍ ᴀ ᴊᴀʏᴀʀᴀᴛʜɴᴀ ᴛᴇᴄʜɴɪᴄᴀʟ ᴛᴇᴀᴍ ᴍᴇᴍʙᴇʀ',
        private: 'BoT private',
        admin: 'ᏢᏞᎬᎪՏᎬ ᏟϴΝՏᏆᎠᎬᎡ,ϴΝᏞᎽ ᏀᎡϴႮᏢ ᎪᎠᎷᏆΝՏ ᏟᎪΝ ႮՏᎬ ͲᎻᏆՏ ᏟϴᎷᎷᎪΝᎠ.\n\n\n ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴡɪᴛʜᴏᴜᴛ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴ ᴘᴏᴡᴇʀs, ʏᴏᴜ ɴᴇᴇᴅ ᴛᴏ ɢᴇᴛ sᴘᴇᴄɪᴀʟ ᴘᴇʀᴍɪssɪᴏɴ ғʀᴏᴍ ᴀ ᴊᴀʏᴀʀᴀᴛʜɴᴀ ᴛᴇᴄʜɴɪᴄᴀʟ ᴛᴇᴀᴍ ᴍᴇᴍʙᴇʀ',
        botAdmin: 'ᏢᏞᎬᎪՏᎬ ᏟϴΝՏᏆᎠᎬᎡ,ϴΝᏞᎽ ᏴϴͲ ᎪᎠᎷᏆΝՏ ᏟᎪΝ ႮՏᎬ ͲᎻᏆՏ ᏟϴᎷᎷᎪΝᎠ.\n\n\n ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴡɪᴛʜᴏᴜᴛ ʙᴏᴛ  ᴀᴅᴍɪɴ ᴘᴏᴡᴇʀs, ʏᴏᴜ ɴᴇᴇᴅ ᴛᴏ ɢᴇᴛ sᴘᴇᴄɪᴀʟ ᴘᴇʀᴍɪssɪᴏɴ ғʀᴏᴍ ᴀ ᴊᴀʏᴀʀᴀᴛʜɴᴀ ᴛᴇᴄʜɴɪᴄᴀʟ ᴛᴇᴀᴍ ᴍᴇᴍʙᴇʀ.',
        unreg: 'Unreduction mode active',
        restrict: 'Reduction mod atctive'
